...
(function() {
  var CLI, Command, Commander, Completer, CreateFriendshipCommand, ListFriendsCommand, PingCommand, QuitCommand, RemoveFriendshipCommand, SocialCoffee, Thrift, readline,
  ...
  PingCommand = (function(_super) {
    ...
    PingCommand.prototype.execute = function(commands) {
      return Thrift.Client.client.ping(function(err, result) {
      ...
      this.cmd_interface.on('line', function(line) {
        ...
        switch (commands[0]) {
          ...
          case "friendship":
            ...
            break;
          case "ping":
            new PingCommand(_this.cmd_interface).execute(commands);
            break;
          case "quit":
